												...
												<div class="row">
													...
													<div class="form-group col-md-4 py-2 mb-0 one box">
														...
														<div class="input-group date" data-date-format="dd MM yyyy">
															<input type="text" class="form-control txt_date2ag" placeholder="dd MM yyyy" id="txt_date2" name="from">
															<div class="input-group-addon" style="display:none;">
																<i class="fa fa-calendar"></i>
															</div>
															<input type="text" class="form-control txt_date3ag" placeholder="dd MM yyyy" id="txt_date3" name="to">
															<div class="input-group-addon" style="display:none;">
																<i class="fa fa-calendar"></i>
															</div>
														</div>	
...
<input type="text" name="senscalendar" id="senscalendar" value="0">

														<button type="button" class="btn btn-info euz_bt rounded-0" id="butSen" name="butSen"><i class="fas fa-search"></i> Search</button>
														&nbsp;&nbsp;
														<button type='button' class="res btn btn-danger euz_bt rounded-0"><i class="fas fa-redo-alt"></i> Reset</button>
													</div>
												</div>
											</div>
										...
										<div class="col-md-12 euz_border">
											<div class="row">
												...
												<div class="form-group col-md-4 py-2 mb-0 one box3">
													<label for="" class="euz_b">From - To Date</label>
													<div class="input-group date " data-date-format="dd MM yyyy">
														<input type="text" class="form-control txt_date2hubag fihub" placeholder="dd MM yyyy" id="txt_date2" name="from">
														<div class="input-group-addon" style="display:none;">
															<i class="fa fa-calendar"></i>
														</div>
														<input type="text" class="form-control txt_date3hubag sechub" placeholder="dd MM yyyy" id="txt_date3" name="to">
														<div class="input-group-addon" style="display:none;">
															<i class="fa fa-calendar"></i>
														</div>
													</div>	
...
//$('.txt_date2ag').datepicker({ format: "dd MM yyyy" });


//$(".txt_date2ag").datepicker('setDate', null);
//$(".txt_date3ag").datepicker('setDate', null);
...
/*var d = new Date();
           ...
           $(".txt_date2ag").datepicker();
           $(".txt_date2ag").datepicker("setDate", startDate);*/
//alert("Inside --ok");
// if ($("#senscalendar").val()==1){
// 	alert("enter inside loop");
// var d = new Date();
//            var currMonth = d.getMonth();
//            var currYear = d.getFullYear();
//            var startDate = new Date(currYear, currMonth,1);
// //$(".txt_date2ag" ).datepicker({ defaultDate:startDate});
// var datepicker = $('.txt_date2ag');
//           datepicker.datepicker();
//            datepicker.datepicker("setDate", startDate);
           //$( ".txt_date2ag" ).datepicker( "option", "disabled", false );
...
// var d1 = new Date();
//            var currMonth1 = d1.getMonth();
//            var currYear1 = d1.getFullYear();
//            var startDate1 = new Date(currYear1, currMonth1, 1);

//           // $(".txt_date3ag").datepicker();
//            $(".txt_date3ag").datepicker("setDate", startDate1);
//             $( ".txt_date3ag" ).datepicker( "option", "disabled", false );
//    }
