											...
											<div class="tab-content euz_border p-3 bg-white">															
												<div class="row">														
													<div class="col-md-12">
														<ul class="nav nav-pills">
															<li class="nav-item euz_b" style="min-width: 150px;">
																<a class="sd nav-link active" data-toggle="pill" href="#sensordata"><i class="fas fa-table"></i> Report</a>
															</li>
															<li class="nav-item euz_b" style="min-width: 150px;">
																...
																<button id="gr1" onclick="graph()" class="w-100 border-0 nav-link" data-toggle="pill" href="#carthub">
																	<i class="fas fa-chart-line"></i> Graphical Report</button>
																</button>
															</li>
														</ul>
...
for($i=0;$i<=25;$i++){
?>
<!--<div style="width:100%;overflow-x:scroll;scrollbar-color:white;scrollbar-width:thin;">-->
<div id="demohub<?php echo $i;?>" class="demohub" style="width:5000px;"></div>
