													...
													<div class="col-md-12">
														<ul class="nav nav-pills">
															<li class="nav-item1 euz_b1" style="min-width: 150px;">
																<a class="sd"  href="#sensordata"><i class="fas fa-table"></i> Report</a>
															</li>
															<li class="nav-item1 euz_b1" style="min-width: 150px;">
																
																<button id="gr1" onclick="graph()" class="w-100 border-0 nav-link"  href="#carthub">
																	<i class="fas fa-chart-line"></i> Graphical Report</button>
																</button>
															</li>
														</ul>
