										...
										<div class="col-md-12 euz_border">
											...
											<div class="row bg-light">
												<div class="col-md-12 p-2">
													...
													&nbsp;&nbsp;
													<button type="reset" class="btn btn-danger euz_bt rounded-0"><i class="fas fa-redo-alt"></i> Reset</abutton>
												</div>
											</div>
...
<button id="gr" onclick="graph()" disabled="disabled" class="w-100 border-0 nav-link" data-toggle="pill" href="#carthub">
<i class="fas fa-chart-line"></i> Graphical Report</button>
													...
													<div class="col-md-6">
														<button class="euz_btn_add euz_pointer float-right" disabled="disabled" style="background-color:#d6d6d6;border:none" type="submit" id="exportsensor" target="_blank">EXPORT</button>
													</div>													
												</div>
...
$.ajax({
			url: "{{ url('/agent/savecharttempdatahub') }}",
			type: "post",
			data: $('#tmefrm2').serialize(),
			success: function(data)
			{
