										...
										<div class="col-md-12 euz_border">
											<div class="row">
												...
												<div class="form-group col-md-4 py-2 mb-0 one box3">
													<label for="" class="euz_b">From - To Date</label>
													<div class="input-group date " data-date-format="dd MM yyyy">
														<input type="text" class="form-control txt_date2hubag" placeholder="dd MM yyyy" id="txt_date2" name="from">
														<div class="input-group-addon" style="display:none;">
															<i class="fa fa-calendar"></i>
														</div>
														<input type="text" class="form-control txt_date3hubag" placeholder="dd MM yyyy" id="txt_date3" name="to">
														<div class="input-group-addon" style="display:none;">
															<i class="fa fa-calendar"></i>
														</div>
													</div>	
											...
											<div class="row bg-light">
												<div class="col-md-6 p-2">
													...
													&nbsp;&nbsp;
													<button type="reset" class="btn resethub btn-danger euz_bt rounded-0"><i class="fas fa-redo-alt"></i> Reset</abutton>
												</div>
												<div class="col-md-6 p-2">
