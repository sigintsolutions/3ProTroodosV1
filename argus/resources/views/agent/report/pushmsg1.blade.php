        ...
        <table class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php /* {{ Str::limit($message->push_message, $limit = 10, $end = '...') }}*/ ?><a href="#" class="euz_inblue" data-toggle="modal" data-target="#pushinfo{{ $message->pid }}"><i class="fas fa-eye"></i> View</a></td>
                </tr>
