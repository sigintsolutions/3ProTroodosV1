					...
					<div class="row">
						<div class="col-md-12 mt-2">
							...
							<div id="gateway" class="tab-pane active"><br>
									...
									<a class="btn euz_btn_add float-right euz_pointer mb-3 euz_newgateway_list_q euz_newgateway_btn_q" href="/admin/addsensorhub"><i class="fas fa-plus"></i> Add Sensor Hub</a>
								...
								<table class="table table-bordered table-striped">
									...
									<tbody>
									@foreach($hubs as $index =>$item)
										<tr>
											<td>{{ $item->sensor_hub_id }}</td>
											<td>{{ $item->fname }}</td>
											<td>{{ $item->groupname }}</td>
											<td>{{ $item->mac_id }}</td>
											<td>{{ $item->name }}</td>
											<td><a href="/admin/showsensor/{{ $item->id }}" class="text-success"><i class="fas fa-plus"></i> Add Sensor</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="editSensorhub/{{ $item->id }}" class="euz_inblue"><i class="fas fa-user-edit"></i> Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="deleteSensorhub/{{ $item->id }}" class="euz_inred" onclick="return confirm('Are you sure to delete this item?')"><i class="fas fa-user-times"></i> Delete</a></td>
										</tr>
									@endforeach
									</tbody>
								</table>
