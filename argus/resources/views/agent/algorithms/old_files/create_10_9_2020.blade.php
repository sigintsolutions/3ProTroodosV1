...
<div class="p-3 add_Algorithm_form">
			<div class="row">
				...
				<div class="col-md-12 euz_border p-3 bg-white">
					<div class="row">
						<div class="col-md-12">
							<a class="btn euz_btn_add float-right euz_pointer add_Algorithm_back" href="/admin/algorithms"><i class="far fa-arrow-alt-circle-left"></i> Back</a>
						</div>
						<div class="col-md-12 mt-2">
							<div class="shadow-sm">
								...
								<form method="post" action="insertalgorithm" name="frmlog" id="frmlog">
								{{ csrf_field() }}
								<div class="col-md-12 euz_border" id="parent">
									...
									<div class="row bg-light">
										<div class="col-md-12 p-2">
											...
											&nbsp;&nbsp;
											<a href="/admin/algorithms" class="euz_inred"><i class="fas fa-broom"></i> Cancel</a>
										</div>
									</div>
								</div>
								</form>
...
{
//alert(vid);
//alert($(this).closest('.items').attr('class'));
//alert($(pid));
//alert("#"+vid+" .hub");
    $.ajax({
        url: "/admin/gethub",
