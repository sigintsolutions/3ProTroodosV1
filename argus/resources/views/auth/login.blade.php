            ...
            <div class="euz_logscreen">
				...
				{{ csrf_field() }}
					<div class="input-group mb-3 px-3">
						...
						<input name="email" type="text" class="form-control" required placeholder="{{ trans('Username') }}">
					...
					<div class="input-group mb-3 px-3">
						...
						<input name="password" type="password" required class="form-control" placeholder="{{ trans('global.login_password') }}">
					</div>
					<?php /*?><div id="dvCaptcha" class="mb-3 px-3" style="width: 100%"></div><?php */?>
					<div class="form-group row">
					<div class="col-md-6" style="padding: 0px 30px;">
					<div class="g-recaptcha"  data-sitekey="6LfKqMQUAAAAAMkmPBk1IDUrPj0VZRwbpzDjL1fz"></div>
