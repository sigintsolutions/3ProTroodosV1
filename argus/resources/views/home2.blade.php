...
$.ajax(
        {
           // url:"{{  url('/editarchive') }}",
           url:"{{url('agent/dashsensedetails')}}",
            method:"GET",
            data:{},
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 mt-3">
                        <div class="shadow-sm">
                            ...
                            <div class="col-md-12 euz_border" style="min-height: 400px;max-height: 400px;overflow:scroll;background-color: #ebf2f9;">
                        ...
                        <div class="shadow-sm">
                            ...
                            <div class="col-md-12 euz_border">
                                <form method="post" name="frmlog" id="frmlog">
                                    {{ csrf_field() }}
                                    <input type="hidden" name="agent" value="<?php echo session()->get('userid'); ?>" />
