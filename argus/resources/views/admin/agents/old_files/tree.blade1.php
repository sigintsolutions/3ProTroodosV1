				...
				{{ csrf_field() }}
					...
					<div class="row">
						...
						<div class="form-group col-lg-3 col-md-4">
							...
							<input type="date" class="form-control" id="service_start"  name="service_start" required value="<?php echo $user[0]->service_start; ?>" />
						</div>
						<div class="form-group col-lg-3 col-md-4">
							<label class="euz_b" for="">Subscription End & Renew Date</label>
							<input type="date" class="form-control" id="service_expiry"  name="service_expiry" required value="<?php echo $user[0]->service_expiry; ?>" />
						</div>
						<div class="form-group col-lg-3 col-md-4">
