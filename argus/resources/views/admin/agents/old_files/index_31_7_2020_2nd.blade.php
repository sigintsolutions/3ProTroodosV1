                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-lg-3 col-md-4 py-2 mb-0">
                                                ...
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" value="1" class="custom-control-input" id="edityes" name="status" <?php if($agent->status == '1') { echo "checked"; } ?> />
                                                    <label class="custom-control-label euz_b" for="edityes">Yes</label>
                                                </div>
                                                <div class="custom-control custom-radio custom-control-inline">
                                                    <input type="radio" value="0" class="custom-control-input" id="editno" name="status" <?php if($agent->status == '0') { echo "checked"; } ?> />
