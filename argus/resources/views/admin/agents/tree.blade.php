				...
				<div class="modal-body">
					<div class="row">
						...
						<!--<div class="form-group col-lg-3 col-md-4">
							...
							<input type="hidden" class="form-control" id="valuedata" value="" name="valuedata" />
						<!--</div>-->
						<div class="form-group col-lg-3 col-md-4">
			...
			<form action="{{ url('admin/updatesensor') }}" method="POST" enctype="multipart/form-data">
				...
				<div class="modal-body">
					<div class="row">
						...
						<!--<div class="form-group col-lg-3 col-md-4">
							<label class="euz_b" for="">Value</label>-->
							<input type="hidden" class="form-control" id="valuedataedit" value="" name="valuedata"  />
						<!--</div>-->
						<div class="form-group col-lg-3 col-md-4">
							<label class="euz_b" for="">Min Value</label>
	...
	$(document).on("click", ".sensoredit", function () 
	{
		...
		$.ajax({
			...
			success:function(data)
			{
				...
				$("#hubnameeditsensor").val(data.hubname);			//alert(data.sensor_id);
