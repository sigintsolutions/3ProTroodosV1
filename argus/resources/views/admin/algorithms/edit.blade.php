									...
									<div class="row">
										<div class="form-group col-md-4 py-2 mb-0">
											...
											<select class="form-control agent" name="agent" required id="agent">
                                                ...
                                                <option value="{{ $item->id }}" selected="selected">{{ $item->fname." ".$item->lname }}</option>
                                                @else
...
<option value="1" {{ ($sensor->condition1=='1')?'selected':'' }}> < (less than) </option>
    														...
    														<div class="form-group col-md-4 py-2 mb-0">
    															...
    															<div class="custom-control custom-radio custom-control-inline">
    																<input type="radio" class="custom-control-input con1" onclick="addmorebtdisable0(this.id);" value="None" id="none{{ $i }}" {{ ($sensor->condition2=='None')?"checked":"" }} name="condition2{{ $i }}">
    																<label class="custom-control-label euz_b label_con1" for="none{{ $i }}">None</label>
    															</div>
    															<div class="custom-control custom-radio custom-control-inline">
    																<input type="radio" class="custom-control-input con2" onclick="addmorebtdisableor0(this.id);" value="Or" id="or{{ $i }}" {{ ($sensor->condition2=='Or')?"checked":"" }} name="condition2{{ $i }}">
