				...
				<div class="row">
					<div class="col-md-3 mt-2">
						<div class="card">
							...
							<div class="card-body pb-0">
								<p class="euz_b"><label style="color: #a6a6a6;margin-right: 10px;">Total</label> <span class="badge badge-success fa-3x p-2"><?php echo count($groups); ?></span></p>
							</div> 
					...
					<div class="col-md-3 mt-2">
						<div class="card">
							...
							<div class="card-body pb-0">
								<p class="euz_b"><label style="color: #a6a6a6;margin-right: 10px;">Total </label> <span class="badge badge-success fa-3x p-2"><?php echo count($types); ?></span></p>
							</div> 
							<div class="card-footer text-right bg-white euz_card_fo">
					...
					<div class="col-md-3 mt-2">
						<div class="card">
							...
							<div class="card-body pb-0">
								<p class="euz_b"><label style="color: #a6a6a6;margin-right: 10px;">Total </label> <span class="badge badge-success fa-3x p-2"><?php echo count($units); ?></span></p>
							</div> 
							<div class="card-footer text-right bg-white euz_card_fo">
		...
		<form method="post" action="{{ url('/admin/addunit') }}">
			<div class="row p-2">
				...
				<div class="col-md-4 form-group my-2">
					...
					<div class="input-group mb-3">
						<select class="form-control" name="name" required id="my_select">
				...
				<div class="col-md-12 my-2">
					<div class="shadow-sm">
						...
						<div class="col-md-12 euz_border chart2">
							<div id="hourly"></div>
						</div>
					...
					<table class="table table-bordered table-striped">
						...
						<tbody>
							...
							<tr>
								...
								<td><a href="" class="text-info euz_td_a" data-id='{{ $group->id }}' data-name='{{ $group->name }}' data-toggle="modal" data-target="#sensorgroup{{ $group->id }}"><i class="fas fa-user-edit"></i> Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<form action="{{ url('/admin/inserttype') }}" method="POST" enctype="multipart/form-data">
			<div class="row  p-2">	
				...
				<div class="col-md-3 form-group my-2">
					...
					<input type="text" class="form-control" name="brand" id="" required />
				</div>
				<!-- <div class="col-md-3 form-group my-2">
				...
				<div class="col-md-3 form-group my-2">
					<label for="" class="euz_b">Min Value</label>
					<input type="text" class="form-control" name="min" id="" required />
				</div>
				<div class="col-md-3 form-group my-2">
					<label for="" class="euz_b">Max Value</label>
					<input type="text" class="form-control" name="max" id="" required />
				</div>
				...
				<table class="table table-bordered table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td>{{ $item->brand }}</td>
							<td>{{ $item->modal }}</td>
							<td><a href="" class="text-info euz_td_a" data-id='{{ $item->id }}' data-name='{{ $item->name }}' data-toggle="modal" data-target="#types{{ $item->id }}"><i class="fas fa-user-edit"></i> Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;
										...
										<form action="updatetype" method="POST" enctype="multipart/form-data">
											...
											<div class="row">
												...
												<div class="form-group col-md-4">
													<label for="" class="euz_b">Max Value</label>
													<div class="input-group mb-3">
														<input type="text" class="form-control" required id="max" value="{{ $item->max }}" name="max" />
													</div>
												</div>
												<div class="form-group col-md-4">
													<label for="" class="euz_b">Min Value</label>
													<div class="input-group mb-3">
														<input type="text" class="form-control" required id="min" value="{{ $item->min }}" name="min" />
													</div>
												</div>
