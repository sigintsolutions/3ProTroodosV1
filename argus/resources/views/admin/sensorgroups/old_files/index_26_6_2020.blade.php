					...
					<table class="table table-bordered table-striped">
						...
						<tbody>
							...
							<tr id="gr<?php echo $group->id;?>">
								...
								<td><a href="" class="text-info euz_td_a" data-id='{{ $group->id }}' data-name='{{ $group->name }}' data-toggle="modal" data-target="#sensorgroup{{ $group->id }}"><i class="far fa-edit"></i> Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;
