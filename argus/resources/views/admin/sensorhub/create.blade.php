								...
								<div id="agent11" class="tab-pane active"><br>
									...
									<div class="row euz_newadmin_form_q">
										...
										<div class="col-md-12 euz_header">
											<p class="text-white euz_b">Add Sensor Hub</p>
										</div>
										<div class="col-md-12 euz_border"><form action="insertsensorhub" method="POST" enctype="multipart/form-data">
										{{ csrf_field() }}
										
											<div class="row p-2">
												<div class="form-group col-md-3 py-2 mb-0">
													<label for="" class="euz_b">Sensor Hub ID</label>
													<input type="text" class="form-control" id="hub_id" name="hub_id" value="{{ $hub_id }}" disabled>
													<input type="hidden" value="{{ $hub_id }}" name="hubid" id="hubid" />
												</div>
												<div class="form-group col-md-3 py-2 mb-0">
