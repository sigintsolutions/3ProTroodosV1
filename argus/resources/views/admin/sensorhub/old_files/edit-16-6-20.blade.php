...
<div class="row">
	<div class="col-md-12">
		...
		<ul class="nav nav-tabs nav-justified">
			...
			<li class="nav-item">
				<a class="nav-link" data-toggle="tab" href="#treecom">Visual Hierarchy</a>
			</li>
		</ul>
							...
							<!-- <div class="input-group"> -->
    							<select class="form-control disname select1" id="" name="hub" disabled="disabled">
									...
									<?php
										...
										if($group[0]->hub_id==$hub['1']) {
									?>   								
    								<option value="<?php echo $hub['1']; ?>" selected="selected"><?php echo $hub['1']; ?></option>
									<?php } else { ?>
			...
			<form action="{{ url('/admin/insertgatewaygroup') }}" method="POST" enctype="multipart/form-data">
				...
				<div class="modal-body">          
					<div class="row">
						...
						<div class="form-group col-lg-3 col-md-4">
							<label class="euz_b" for="">Gateway Group Name</label>
							<select class="form-control" id="" name="sensor_group_id">
			...
			<form action="{{ url('admin/updategatewaygroup') }}" method="POST" enctype="multipart/form-data">
				...
				<div class="modal-body">
					<div class="row">
						...
						<div class="form-group col-lg-3 col-md-4">
							<label class="euz_b" for="">Gateway Group Name</label>
							<select class="form-control"  name="sensor_group_id" id="sensor_group_id">
								<option value="">-Select Group Name-</option>
								@foreach($groupnames as $item)
								<option value="{{ $item->id }}">{{ $item->name }}</option>
								@endforeach
				...
				<div class="modal-body">
					<div class="row">
						...
						<div class="form-group col-lg-3 col-md-4">
                            <label class="euz_b" for="">Sensor Hub Name</label>
                            <div class="input-group">
                                <select class="form-control disname select1" id="hub" name="hub">
