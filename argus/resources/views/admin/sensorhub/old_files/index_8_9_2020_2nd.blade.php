...
@section('content')
    ...
    <div class="p-3">
            <div class="row">
                ...
                <script>
                    var msg = '{{Session::get('jsAlert4')}}';
                    var exist = '{{Session::has('jsAlert4')}}';
                    if(exist)
                    {
                        alert(msg);
                    }
    ...
    <!---End Profile---->
    <a href="#" class=" btn euz_float_grexport euz_ied sensormulimport" title="Sensor Import" data-toggle="modal" data-target="#sensormulimport" style="padding: 6px;padding-left: 6px;font-size: 16px;"><i class="fas fa-microchip"></i></a>
                ...
                {{ csrf_field() }}
                    ...
                    <input type="hidden" value="<?php echo $groupname[0]->id; ?>" name="group" id="" />
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-3 col-md-4">
                                <label class="euz_b" for="">Sensor Hub Namem</label>
                            ...
                            <div class="form-group col-lg-3 col-md-4">
                                ...
                                <input type="text" class="form-control disname mac" required id="" value="" name="mac" onblur="checkmacid();" />
                            </div>
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="macsave btn btn-success rounded-0 euz_bt" id="butSen"><i class="far fa-save"></i> Save</button>
                        <button type="button" class="btn btn-danger rounded-0 euz_bt" data-dismiss="modal"><i class="fas fa-times"></i> Cancel</button>
                    </div>
                </form>
				</div>
...
//var docurl = url + "/" + hubid;
            $.ajax({
                ...
                {
                	if (response>0){
                		//$(".macsave").attr("disabled","true");
                		$('.macsave').prop('disabled', true);
                		$(".mac").val('');
                		alert("Already this MAC ID used. Try new MAC ID");

                	}
                	else{
                		//$(".macsave").attr("disabled","false");
                		$('.macsave').prop('disabled',false);
                	}
                    //alert(response);
                    //location.reload();
                }
