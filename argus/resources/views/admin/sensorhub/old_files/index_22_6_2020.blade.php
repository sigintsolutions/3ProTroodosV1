                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-3 col-md-4">
                                ...
                                <!-- <div class="input-group"> -->
                                    <select class="form-control select1" id="" name="hub">
                            ...
                            <div class="form-group col-lg-3 col-md-4">
                                ...
                                <input type="text" class="form-control disname" id="" value="" name="mac" />
                            </div>
                ...
                <form action="{{ url('admin/updatesensorhub') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-3 col-md-4">
                                <label class="euz_b" for="">MAC ID</label>
                                <input type="text" class="form-control disname" id="mac" value="" name="mac">
                            </div>
