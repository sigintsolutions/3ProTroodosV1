...
<div class="p-3 add_admin_form">
			<div class="row">
				<div class="col-md-12 euz_bar">
					<i class="fas fa-user-tie euz_text_blue"></i> <small class="euz_b euz_text_blue"><a class="euz_text_blue euz_pointer add_admin_back">Admin</a></small>
				</div>
							...
							<div class="shadow-sm">
								...
								<div class="col-md-12 euz_border">
									<div class="row">
										...
										<div class="form-group col-md-4 py-2 mb-0">
											<label for="" class="euz_b">Login Email</label>
											<input class="form-control" type="email" id="username" name="username" value="{{ $user[0]->email }}" required>
										</div>
										<div class="form-group col-md-4 py-2 mb-0" style="display: none;">
											<label for="" class="euz_b">Old Password</label>
											<input class="form-control" type="text" id="oldpassword" name="oldpassword" value="{{ $user[0]->original }}" />
										</div>
										<div class="form-group col-md-4 py-2 mb-0">
											<label for="" class="euz_b">New Password</label>
											<input class="form-control" type="password" id="password" name="password" >
										</div>
										<div class="form-group col-md-4 py-2 mb-0">
											<label for="" class="euz_b">Confirm Password</label>
											<input class="form-control" type="password" id="confirm" name="confirm">
										</div>
										
										<div class="form-group col-md-4 py-2 mb-0 mt-4">
											<input type="checkbox" name="sendmail" value="Y" id="sendmail" />
											<span for="" class="euz_b">System will send profile modification message to the corresponding login email id</span>
										...
										<div class="form-group col-md-12 py-2 mb-0" id="mailtemp" style="display:none;">
											...
											<textarea type="text" class="form-control" required rows="10" id="template" name="template" placeholder="Dear << firstname >>, .....">{{ (@$user[0]->email_template)?@$user[0]->email_template:"" }}</textarea>
											<?php /*?><input class="form-control" type="password" id="confirm" name="confirm"><?php */?>
										</div>
									...
									<div class="row bg-light">
										<div class="col-md-12 p-2">
											<button type="submit" class="btn btn-success rounded-0 border-0 euz_bt"><i class="fas fa-save"></i> Save</button>
											&nbsp;&nbsp;
											<a href="{{ url('/admin/users') }}" class="btn btn-danger rounded-0 border-0 euz_bt"><i class="fas fa-times"></i> Cancel</a>
										</div>
									</div>
								</div>
								</form>
