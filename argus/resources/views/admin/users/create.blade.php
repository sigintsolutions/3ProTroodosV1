							...
							<div class="shadow-sm">
								...
								<div class="col-md-12 euz_border">
									<div class="row">
										...
										<div class="form-group col-md-6 py-2 mb-0" id="mailtemp" style="display:none;">
											<label for="" class="euz_b">Mail Template</label>
											<textarea type="text" class="form-control" required rows="10" id="template" name="template" placeholder="Dear << firstname >>, .....">{{ (@$settings[0]->admin_email)?@$settings[0]->admin_email:"" }}</textarea>
											<?php /*?><input class="form-control" type="password" id="confirm" name="confirm"><?php */?>
										</div>
									...
									<div class="row bg-light">
										<div class="col-md-12 p-2">
											...
											&nbsp;&nbsp;
											<a href="{{ url('/admin/users') }}" class="btn btn-danger rounded-0 euz_bt"><i class="fas fa-times"></i> Cancel</a>
										</div>
									</div>
								</div>
								</form>
