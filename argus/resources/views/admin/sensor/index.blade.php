...
<!--List sensor--->
    ...
    <div class="p-3">
        <div class="row">
           ...
           <script>
            ...
            <script>
                var msg = '{{Session::get('jsAlert2')}}';
                var exist = '{{Session::has('jsAlert2')}}';
                if(exist)
                {
                    alert(msg);
                }
                    ...
                    <div class="col-md-4 mt-2">
                        <div class="card">
                            ...
                            <div class="card-footer text-right bg-white euz_card_fo pr-2">
                                ...
                                <a href="<?php echo url('/admin/deleteSensor/'.$item->sensorid); ?>" class="ml-2" title="Delete" onclick="return confirm('Are you sure do you want to delete?')"><i class="fas fa-trash-alt euz_a_icon"></i></a>
                            </div>
                        </div>
                    </div>
                    @endforeach
    ...
    <a href="javascript:void(0)" class="btn euz_float_add sensoradd" data-toggle="modal" data-target="#sensoradd" ><i class="fas fa-plus"></i></a>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable euz_w_90">
            <div class="modal-content" style="width: 40%;">
                ...
                <form method="post" enctype="multipart/form-data" action="{{ url('admin/import_excel/sensoreditimport') }}">
                    ...
                    <input type="hidden" value="<?php echo $user[0]->id; ?>" id="agentdrop" name="agentdrop" />
                    <input type="hidden" value="<?php echo $group[0]->id; ?>" id="" name="groupdrop" />
                    <input type="hidden" value="<?php echo $group[0]->sensor_group_id; ?>" id="" name="sensorgroupdrop" />
...
<img id="eimg" src="" class="img-fluid" style="width:100px;">
    ...
    <div class="modal fade" id="sensoradd">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable euz_w_90">
            <div class="modal-content">
				<div id="loader" style="background: #ffffffe0 none repeat scroll 0px 0px; position: fixed;  z-index: 1000001;   display: block;width: 90%;height: 90%;"><center><img src="{{ url('/loader/3.gif') }}"></center></div>		
                <div class="modal-header euz_carb p-0">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group col-lg-3 col-md-4">
                                ...
                                <input type="text" class="form-control disname" id="hubnamedrop" value="<?php echo $hubname[0]->hub_id; ?>" disabled="disabled">
                            </div>
                            <div class="form-group col-lg-3 col-md-4">
                                <label class="euz_b" for="">Sensor ID</label>
                                <select class="form-control" id="country_name" name="sensor_id" required>
                                    <?php /*<option value="">-Select Type-</option>
    ...
    <div class="modal fade" id="sensoredit">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable euz_w_90">
            <div class="modal-content">
				<div id="loaderedit" style="background: #ffffffe0 none repeat scroll 0px 0px; position: fixed;  z-index: 1000001;   display: block;width: 90%;height: 90%;"><center><img src="{{ url('/loader/3.gif') }}"></center></div>			
                <div class="modal-header euz_carb p-0">
            ...
            $.ajax({
                ...
                success:function(data)
                {
                   ...
                   // $("#sensor_id").val(data.sensor_id);
                    ...
                    var hubname = $("#hubnamedrop").val();
                    //var sensorname = encodeURIComponent(data.sensor_id);
                    //var url = "{{ url('/admin/addsensordrop') }}";
                    //var docurl = url + "/" + hubname + "/" + sensorname;
...
if (data.cname=='BarChart'){
imgpath="https://mqtt.eurozapp.eu/argus/image/tumb/bar.PNG";
}
if (data.cname=='ColumnChart'){
imgpath="https://mqtt.eurozapp.eu/argus/image/tumb/column.PNG";
}
if (data.cname=='ComboChart'){
imgpath="https://mqtt.eurozapp.eu/argus/image/tumb/combo.PNG";
}
if (data.cname=='HistogramChart'){
imgpath="https://mqtt.eurozapp.eu/argus/image/tumb/histogram.PNG";
}

if (data.cname=='LineChart'){
imgpath="https://mqtt.eurozapp.eu/argus/image/tumb/line.PNG";
}
if (data.cname=='PieChart'){
imgpath="https://mqtt.eurozapp.eu/argus/image/tumb/pie.PNG";
}
if (data.cname=='ScatterChart'){
imgpath="https://mqtt.eurozapp.eu/argus/image/tumb/scatter.PNG";
}
if (data.cname=='SteppedAreaChart'){
imgpath="https://mqtt.eurozapp.eu/argus/image/tumb/stepped.PNG";
}*/
var urli = "{{ url('/image/tumb/') }}";
imgpath=urli+'/area.PNG';
//alert(imgpath);
if (data.cname=='AreaChart'){
//imgpath="https://mqtt.eurozapp.eu/argus/image/tumb/area.PNG";
imgpath=urli+'/area.PNG';
...
if (data.cname=='BarChart'){
//imgpath="https://mqtt.eurozapp.eu/argus/image/tumb/bar.PNG";
imgpath=urli+'/bar.PNG';

}
if (data.cname=='ColumnChart'){
//imgpath="https://mqtt.eurozapp.eu/argus/image/tumb/column.PNG";

imgpath=urli+'/column.PNG';
}
if (data.cname=='ComboChart'){
//imgpath="https://mqtt.eurozapp.eu/argus/image/tumb/combo.PNG";
imgpath=urli+'/combo.PNG';
}
if (data.cname=='HistogramChart'){
//imgpath="https://mqtt.eurozapp.eu/argus/image/tumb/histogram.PNG";
imgpath=urli+'/histogram.PNG';
}

if (data.cname=='LineChart'){
//imgpath="https://mqtt.eurozapp.eu/argus/image/tumb/line.PNG";
imgpath=urli+'/line.PNG';
}
if (data.cname=='PieChart'){
    imgpath=urli+'/pie.PNG';
//imgpath="https://mqtt.eurozapp.eu/argus/image/tumb/pie.PNG";
}
if (data.cname=='ScatterChart'){
    //var imurl={{url('image/tumb/scatter.PNG')}};
    //imgpath=imurl;
//imgpath="https://mqtt.eurozapp.eu/argus/image/tumb/scatter.PNG";
imgpath=urli+'/scatter.PNG';
//alert(imgpath);
}
if (data.cname=='SteppedAreaChart'){
//imgpath="https://mqtt.eurozapp.eu/argus/image/tumb/stepped.PNG";
imgpath=urli+'/stepped.PNG';
}
...
$("#aimg").attr("src",imgpath);
        ...
        $('#country_name').on('change', function () 
        {
            ...
            var hubname = $("#hubnamedrop").val();
            var agentname = $("#agentdrop").val();
            var url1 = "{{ url('/admin/getsensordrop?val1') }}";
            var url2 = "&val2";
            var url3 = "&val3";
            var docurl = url1 + "=" + hubname + url2 + "=" + selectData + url3 + "=" + agentname;
            $.ajax(
            {
                url : docurl,
                method : "GET",
                success:function(data)
                {
                    ...
                    {
                        alert('This Sensor already added in the same Sensor Hub :' + hubname)
                        return false;
                    }
                }
            });
