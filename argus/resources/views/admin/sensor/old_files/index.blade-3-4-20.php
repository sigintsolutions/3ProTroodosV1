					...
					<div class="row">
						<div class="col-md-12 mt-2">
							...
							<div id="gateway" class="tab-pane active"><br>
									...
									<a class="btn euz_btn_add float-right euz_pointer mb-3 euz_back_btn_q ml-3" href="/admin/sensorhubs"><i class="far fa-arrow-alt-circle-left"></i> Back to Sensor Hub</a>										
										
									<a class="btn euz_btn_add float-right euz_pointer mb-3 euz_newgateway_list_q euz_newgateway_btn_q" href="/admin/addsensor/{{ $hubid }}"><i class="fas fa-plus"></i> Add Sensor</a>
								...
								<table class="table table-bordered table-striped">
									...
									@foreach($sensors as $index =>$item)
										<tr>
											...
											<td><a href="/admin/editSensor/{{ $item->sensorid }}/{{ $hubid }}" class="euz_inblue"><i class="fas fa-user-edit"></i> Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/admin/deleteSensor/{{ $item->sensorid }}" class="euz_inred" onclick="return confirm('Are you sure to delete this item?')"><i class="fas fa-user-times"></i> Delete</a></td>
										</tr>
									@endforeach
									</tbody>
								</table>
