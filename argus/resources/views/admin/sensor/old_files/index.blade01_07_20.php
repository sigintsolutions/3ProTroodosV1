...
<!---- euz_div ----->
    ...
    <div id="loader" style="display:none; background: none repeat scroll 0 0 black; position: fixed; opacity: 0.5; z-index: 1000001; top: 200px; left: 600px;"><img src="{{ url('/loader/3.gif') }}"></div>
    <div class="p-3">
        <div class="row">
