...
<script src="https://www.gstatic.com/charts/loader.js"></script>
  <script type="text/javascript">
  	//loading areachart sensor time report by default
...
for($i=0;$i<=25;$i++){
?>
<div class="euzscrollbar scrooldiv<?php echo $i;?>" style="width:100%;overflow-x:scroll;overflow-y:hidden;scrollbar-color: #cacaca white;margin-bottom:15px; display: none;" id="">
...
//deleting temp data table in case of sensor time report
$.ajax(
        {
...
//saving in temp data search criteria data
xhr=$.ajax({
...
var nameArr1 = jsonData.hour[k][0].split(',');						//alert(nameArr.length);
if (nameArr.length>0){
	var m=0;
	var dt="";
...
,
						...
						else if(nameArr.length < 1800)
						{
							...
							vAxis: {title:unit,titleTextStyle: {fontSize:15},textStyle : {fontSize:15} },
							hAxis: {
									title: 'TIME',titleTextStyle: {fontSize:15}, 
									direction:-1, slantedText:true, slantedTextAngle:90,
									textStyle : {
...
<script>
	...
	//Fetching values in Group drop down
	...
	//Fetching values in Hub drop down
	...
	//Fetching values in unit drop down
	$(".hub").change(function()
	{
		//alert();
		$.ajax(
...
<script>
	...
	//Fetching values in various drop down
	...
	//Drop down change sensor time report chart
...
//Reset Sensor Time Report Search
$(".res").click(function () 
{
	$("#senscalendar").val(1);
	$("#group").val('default');
...
//Hide and show Sensor Time Table and Chart div
$(".fe").click(function(){
//alert("table");
$(".sl").show();
$("#cart").hide();
...
//alert("enter");
	...
	function updatereadall()
	{
		...
		//Updating read flag that all messages read
		var msgid = 'all';
...
$(document).ready(function(){
//one month dates should come for custom dates
