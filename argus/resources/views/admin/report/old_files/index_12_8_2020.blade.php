...
<input type="hidden" name="dynamicchartval" id="dynamicchartval"  />
													...
													<div class="row">
														...
														<div class="form-group col-md-4 py-2 mb-0 one box3">
															<label for="" class="euz_b">From - To Date</label>
															<div class="input-group date" data-date-format="dd MM yyyy">
																<input type="text" class="form-control txt_date2hub" placeholder="dd MM yyyy" id="txt_date2" name="from">
																<div class="input-group-addon" style="display:none;">
																	<i class="fa fa-calendar"></i>
																</div>
																<input type="text" class="form-control txt_date3hub" placeholder="dd MM yyyy" id="txt_date3" name="to">
																<div class="input-group-addon" style="display:none;">
																	<i class="fa fa-calendar"></i>
																</div>
															</div>	
...
$(document).ready(function(){
    ...
    $(".txt_date2hub").datepicker({
        todayBtn:  1,
        autoclose: true,
    }).on('changeDate', function (selected) {
        var minDate = new Date(selected.date.valueOf());
        $('.txt_date3hub').datepicker('setStartDate', minDate);
		var newDate = new Date(selected.date);
		newDate.setDate(newDate.getDate() + 29);
		$('.txt_date3hub').datepicker('setEndDate', newDate);
    });

    $(".txt_date3hub").datepicker()
        .on('changeDate', function (selected) {
            var maxDate = new Date(selected.date.valueOf());
            $('.txt_date2hub').datepicker('setEndDate', maxDate);
        });
