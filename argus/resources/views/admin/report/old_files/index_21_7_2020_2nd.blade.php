				...
				<div class="row">
					<div class="col-md-12 mt-2">
						<ul class="nav nav-tabs euz_tab" role="tablist">
							...
							<li class="nav-item">
								<a class="nav-link euz_tabtex" data-toggle="tab" href="#PushNotification"><i class="fas fa-user-clock"></i> Push Notification 
												...
												<div class="col-md-12 euz_border">
													<div class="row">
														...
														<div class="form-group col-md-3 py-2 mb-0">
															...
															<div class="group">
																<select class="form-control" id="group" name="group[]" multiple="multiple" required></select>												
															</div>
														</div>
														<div class="form-group col-md-3 py-2 mb-0">
...
<a  class="nav-link" data-toggle="pill" href="#cart"><i class="fas fa-chart-line"></i> <button disabled="disabled" style="background-color:#d6d6d6" id="gr" type="button" onclick="graph()" class="euz_btn_add euz_pointer float-right" >Graphical Report</button></a>
															...
															<div class="col-md-7">
																<div class="input-group float-right w-50">
																	...
																	<button disabled="disabled" style="background-color:#d6d6d6" class="euz_btn_add euz_pointer float-right ml-3" type="submit" id="exportsensor" target="_blank">EXPORT</button>
																</div>
															</div>														
