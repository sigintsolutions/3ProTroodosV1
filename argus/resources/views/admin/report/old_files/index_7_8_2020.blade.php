...
<button id="gr" disabled="disabled" class="w-100 border-0 nav-link" data-toggle="pill" href="#cart">
...
<input type="text" name="dynamicchartval" id="dynamicchartval"  />
...
<div id="chartajaxhubdy">place<span id="app">pl</span>														</div>
																</div>
															</div>
														</div>
													</div>
...
getchart2();
		...
		//var netcount=22;
		/*var netcount=4;
		for(var n=3;n<netcount;n++){
			getchart2nextsensdy(n);
		}*/
/*function getcount(){
$.ajax(
		{
			url: "{{ url('/admin/getsensordatachartdy') }}",
			type: "post",
			data: $('#tmefrm2').serialize(),
...
//alert("val length"+jsonData.value[k].length);
alert("val length"+jsonData.value[0].length);
alert("chart"+jsonData.chart[0][0]);
alert("Time length"+jsonData.hour[0].length);
alert("firstvalue"+jsonData.value[0][0]);
//alert("secvalue"+jsonData.value[0][1]);
...
//data[k].addRow([parseInt('7'),parseInt('0')]);
//data[k].addRow([parseInt(8),parseInt(5)]);
							alert("aaaa---");
									var chart = new google.visualization.AreaChart(document.getElementById('hubchart'+k))
...
/*function getchart2nextsens()
	{
		$(".loaderhub1").show();
		$.ajax(
		{
			url: "{{ url('/admin/getsensordatachartnextsens') }}",
			type: "post",
			data: $('#tmefrm2').serialize(),
			success: function(data1)
			{	
...
var chart = new google.visualization.AreaChart(document.getElementById('hubchartnewsensors'))
...
var chart = new google.visualization.BarChart(document.getElementById('hubchartnewsensors'));
...
var chart = new google.visualization.PieChart(document.getElementById('hubchartnewsensors'));
...
var chart = new google.visualization.ColumnChart(document.getElementById('hubchartnewsensors'));
...
var chart = new google.visualization.ComboChart(document.getElementById('hubchartnewsensors'));
...
var chart = new google.visualization.SteppedAreaChart(document.getElementById('hubchartnewsensors'));
...
var chart = new google.visualization.Histogram(document.getElementById('hubchartnewsensors'));
...
var chart = new google.visualization.LineChart(document.getElementById('hubchartnewsensors'));
...
/*function getchart2nextsens3()
	{
		$(".loaderhub2").show();
		$.ajax(
		{
			url: "{{ url('/admin/getsensordatachartnextsens3') }}",
			type: "post",
			data: $('#tmefrm2').serialize(),
			success: function(data1)
			{	
				...
				var count = jsonData.count;
						...
						for (k=0;k<count;k++)
						{
							...
							data[k].addColumn('string', 'Date');
							data[k].addColumn('number', 'Value');
							var title =  '3-Hub/SensorID - ' + jsonData.hub[k] + '/' + jsonData.sensor_id[k];
...
var chart = new google.visualization.AreaChart(document.getElementById('hubchartnewsensors3'))
...
var chart = new google.visualization.BarChart(document.getElementById('hubchartnewsensors3'));
...
var chart = new google.visualization.PieChart(document.getElementById('hubchartnewsensors3'));
...
var chart = new google.visualization.ColumnChart(document.getElementById('hubchartnewsensors3'));
...
var chart = new google.visualization.ComboChart(document.getElementById('hubchartnewsensors3'));
...
var chart = new google.visualization.SteppedAreaChart(document.getElementById('hubchartnewsensors3'));
...
var chart = new google.visualization.Histogram(document.getElementById('hubchartnewsensors3'));
...
var chart = new google.visualization.LineChart(document.getElementById('hubchartnewsensors3'));
...
/*function getchart2nextsensdy(n){


$(".loaderhub"+n).show();
$("#dynamicchartval").val(n);
		$.ajax(
		{
			url: "{{ url('/admin/getsensordatachartnextsens3dy') }}",
			type: "post",
			data: $('#tmefrm2').serialize(),
			success: function(data1)
			{	
				...
				var count = jsonData.count;
				var newcount=n;
				var url = "{{ url('/admin/getchartcounthubdy') }}";
				
				var docurl = url + "/" + newcount;
				$.ajax(
				{
					url: docurl,
					type: "GET",
...
var chart = new google.visualization.AreaChart(document.getElementById('hubchartdy'+newcount))
...
var chart = new google.visualization.BarChart(document.getElementById('hubchartdy'+newcount));
...
var chart = new google.visualization.PieChart(document.getElementById('hubchartdy'+newcount));
...
var chart = new google.visualization.ColumnChart(document.getElementById('hubchartdy'+newcount));
...
var chart = new google.visualization.ComboChart(document.getElementById('hubchartdy'+newcount));
...
var chart = new google.visualization.SteppedAreaChart(document.getElementById('hubchartdy'+newcount));
...
var chart = new google.visualization.Histogram(document.getElementById('hubchartdy'+newcount));
...
var chart = new google.visualization.LineChart(document.getElementById('hubchartdy'+newcount));
