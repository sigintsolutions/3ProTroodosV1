...
<div id="demottty<?php echo $i;?>" class="sensdemo" style="width:5000px;">uuuuuu</div></div>
<?php } ?>
												...
												<div class="tab-content euz_border p-3 bg-white">
													<div class="row">				
														<div class="col-md-12">
															<ul class="nav nav-pills">
																<li class="nav-item euz_b" style="min-width: 150px;">
																	<a onclick="hidecarthub();" class="nav-link active" data-toggle="pill" href="#sensordata"><i class="fas fa-table"></i> Report</a>
																</li>
																<li class="nav-item euz_b" style="min-width: 150px;">
																	<a onclick="showcarthub();" class="nav-link" data-toggle="pill" href="#carthub"><i class="fas fa-chart-line"></i> Graphical Report</a>
																</li>
															</ul>
														</div>	
...
<!---div end--->
							...
							<div id="PushNotification" class="tab-pane fade">
								<form method="post" name="frmPush" id="frmPush">
									...
									<div id="msgload" class="px-0 euz_re">&nbsp;ooo
...
var options = 
              {
                title : 'kkkk',titleTextStyle: {fontSize:15},
...
var options = 
              {
                ...
                /*vAxis: {title:'kkkk',titleTextStyle: {fontSize:15},textStyle : {
fontSize:15} },
                hAxis: {
...
bottom: 200,left :"2%",right:"2%",
      ...
      var chart = new google.visualization.AreaChart(document.getElementById('demo0'));
