															...
															<div class="col-md-5">
																<ul class="nav nav-pills">
																	<li class="nav-item euz_b" style="min-width: 150px;">
																		<a class="fe nav-link active" data-toggle="pill" href="#sensorlist"><i class="fas fa-table"></i> Report</a><span id="chdtp" style="display:none">Chart Data Processing</span>
																	</li>
																	<li class="nav-item euz_b" style="min-width: 150px;">
