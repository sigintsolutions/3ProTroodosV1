													...
													<li>
														<span>
															...
															<div class="sensor_tree1">
																<a href="<?php echo url('/admin/deleteSensor/'.$sensor->id); ?>" onclick="return confirm('Are you sure do you want to delete?')"><i class="fas fa-trash-alt text-danger"></i></a>
				...
				<div class="modal-body">
					<div class="row">
						...
						<div class="form-group col-lg-3 col-md-4">
							...
							<input type="text" class="form-control" id="sim_no" value="" required name="sim_no" />
						</div>
	...
	<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable euz_w_90">
		<div class="modal-content">
			...
			{{ csrf_field() }}
					...
					<div class="row">
						...
						<div class="form-group col-lg-3 col-md-4">
							...
							<select class="form-control" id="" name="hub" required>
								...
								<!--<option value="<?php //echo $item->hub_id; ?>"><?php //echo $item->hub_id; ?></option>-->
						...
						<div class="form-group col-lg-3 col-md-4">
							...
							<input type="text" class="form-control" id="" required value="" name="mac" />
						</div>
				...
				<div class="modal-footer">
					<button type="submit" class="btn btn-success rounded-0 euz_bt">Save</button>
					<button type="button" class="btn btn-danger rounded-0 euz_bt" data-dismiss="modal"><i class="fas fa-times"></i> Cancel</button>
				</div>
			</form>
		</div>
	...
	<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable euz_w_90">
		<div class="modal-content">
			...
			<form action="{{ url('/admin/insertsensor') }}" method="POST" enctype="multipart/form-data">
				...
				<input type="hidden" value="" id="groupdrop" name="groupdrop" />
				<input type="hidden" value="" id="sensorgroupdrop" name="sensorgroupdrop" />
				<div class="modal-body">
					<div class="row">
						<div class="form-group col-lg-3 col-md-4">
							<label class="euz_b" for="">Agent</label>
						...
						<!--<div class="form-group col-lg-3 col-md-4">
							...
							<input type="hidden" class="form-control" id="valuedata" value="" name="valuedata" required />
						<!--</div>-->
						<div class="form-group col-lg-3 col-md-4">
			...
			<form action="{{ url('admin/updatesensor') }}" method="POST" enctype="multipart/form-data">
				...
				<div class="modal-body">
					<div class="row">
						...
						<!--<div class="form-group col-lg-3 col-md-4">
							<label class="euz_b" for="">Value</label>-->
							<input type="hidden" class="form-control" id="valuedataedit" value="" name="valuedata" required />
						<!--</div>-->
						<div class="form-group col-lg-3 col-md-4">
							<label class="euz_b" for="">Min Value</label>
	...
	$(document).on("click", ".sensoradd", function () 
	{
		...
		$.ajax({
			...
			{	
				...
				$("#groupdrop").val(data.group_id);
				$("#sensorgroupdrop").val(data.sensor_group_id);
