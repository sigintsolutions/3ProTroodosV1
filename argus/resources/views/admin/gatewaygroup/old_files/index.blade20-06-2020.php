                    ...
                    <div class="col-md-4 mt-2">
                        <div class="card">
                            ...
                            <div class="card-body pb-0 euz_b px-2">
                                <p class="mb-2">Sim card / Ref:Id : <?php echo $group->sim_no; ?></p>
                                <p class="mb-2">Longitude : <?php echo $group->longitude; ?><br> Latitude : <?php echo $group->latitude; ?></p>
                            </div> 
                            ...
                            <div class="card-footer text-right bg-white euz_card_fo">
                                <span class="ml-2 float-left euz_gren" style="font-size:16px;">Number of Hub : <?php echo count($hubcnt); ?></span>
                                ...
                                <a href="<?php echo url('/admin/sensorhubs/'.$group->agent.'/'.$group->id); ?>" class="ml-2" data-toggle="tooltip" data-placement="top" title="Sensor Hub"><i class="fab fa-hubspot euz_a_icon"></i></a>
                                <a href="#" class="ml-2 modalLink"  data-id="{{ $group->id }}" data-toggle="modal" data-target="#groupedit"><i class="fas fa-edit euz_a_icon"></i></a>
                                <a href="<?php echo url('/admin/deleteGatewaygroup/'.$group->id); ?>" class="ml-2" onclick="return confirm('Are you sure do you want to delete?')"><i class="fas fa-trash-alt euz_a_icon"></i></a>
                                <a href="javascript:void(0)" class="ml-2 euz_tree_in" data-toggle="tooltip" data-placement="top" title="Visual Hierarchy" onclick="profileopentree(<?php echo $group->id;?>)"><i class="fas fa-sitemap"></i></a>
                            </div>
                        </div>
                    </div>
                    <?php } ?>
