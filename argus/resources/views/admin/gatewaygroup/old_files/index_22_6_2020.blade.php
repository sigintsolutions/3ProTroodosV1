                    ...
                    <div class="col-md-4 mt-2">
                        <div class="card">
							...
							<div class="card-footer bg-white euz_card_fo py-0">
								<label style="font-size:14px;width: 50%;color: #666;" class="m-0 euz_tree_in p-1">Hub/s : 0</label><label style="font-size:14px;width: 50%;color: #666;" class="m-0 euz_tree_in p-1">Sensor/s : 0</label>
							</div>
