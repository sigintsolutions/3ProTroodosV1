                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mt-2">
                        <div class="card">
                            ...
                            <?php $hubs = DB::table('sensor_hubs')->where('group_id', $group->id)->where('agent', $group->agent)->get(); ?>
                            <div class="card-footer text-right bg-white euz_card_fo">
                                <span class="ml-2 float-left euz_gren" style="font-size:16px;">Number of Hub : <?php echo count($hubs); ?></span>
