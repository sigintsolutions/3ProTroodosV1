									...
									<div class="row">
										...
										<div class="form-group col-md-8 py-2 mb-0">
											...
											<div class="input-group mb-3">
												<select class="form-control place" name="locid" id="">
													<option>--select--</option>
												...
												<div class="input-group-append">
													<a href="<?php echo url('/admin/loc'); ?>" class="btn btn-info euz_bt rounded-0" type="submit"><i class="fas fa-plus"></i> Add New Location</a> 
												</div>
											</div>
										</div>
									</div>	
