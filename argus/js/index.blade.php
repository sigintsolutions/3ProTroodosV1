													...
													<div class="tab-content euz_border p-3 bg-white">
														...
														<div class="tab-pane fade" id="carthub">
															<div class="row mt-5">
																<div class="col-md-12 mt-3">
																	<div class="shadow-sm">
																		<!-- <div class="progress loaderhub">																		
																			<div class="progress-bar progress-bar-striped progress-bar-animated" style="width:100%" id="myBar"><b>1%</b></div>																			
																		</div> -->
...
<script>
	...
	function getchart2()
	{
		$.ajax(
		{
			...
			// 	});
			// },
			success: function(data1, event, position, total, percentComplete)
			{	
				alert();
				var percentValue = percentComplete + '%';
				$("#progressBar").animate({
	...
	<style>
		/* .loaderhub 
		{
			...
			height: 100vh;
			z-index: 9999;
			background: url(../image/newgif.gif) 50% 50% no-repeat rgb(0, 0, 32);
			opacity: 1;
		} */
		.progress 
		{
