...
Route::get('alogin', 'HomeController@alogin');
...
Route::post('getgroupalg', 'AlgorithmsController@getGroupalg');
	Route::post('gethubalg','AlgorithmsController@getHubalg');
...
//Route::get('addsensorpopval2edit', 'AgentsController@addsensorpopval2edit');
Route::get('addsensorpopval2edit/{id}/{id2}', 'AgentsController@addsensorpopval2');
