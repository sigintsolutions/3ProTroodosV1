...
$slarr[]=$sl->sensor_id;
	...
	//$sql = 'SELECT *FROM dbo_payloaderalgorithmtemp WHERE processedflag = 0 WHERE sensor_id IN ('.$ids.') ORDER BY id ASC LIMIT 1 '; 
	//$sql = 'SELECT *FROM dbo_payloaderalgorithmtemp WHERE processedflag = 0 and sensor_id IN ('.$ids.') ORDER BY id ASC LIMIT 1 ';
	//$sql = "SELECT *FROM dbo_payloaderalgorithmtemp WHERE processedflag = 0 and sensor_id='BME280#3' ORDER BY id ASC LIMIT 1";
	
	//$sql = "SELECT *FROM dbo_payloaderalgorithmtemp WHERE processedflag = 0 and sensor_id IN ('.$ids.') ORDER BY id ASC LIMIT 1";
	    //$users=array("'Vito'","'Joey'","'Vinny'");
	    //echo $ids = implode(', ', $users);
    //echo $sql = "SELECT * FROM `users` WHERE users in $ids";
