...
$items=DB::table('dbo_payloadercharttemp as db')->where('db.unit', $this->data['unit'])->whereRaw('db.utc between "'.$start_week.'" and "'.$end_week.'"')->where('loginid',$this->data['loginid'])->select('agentname','gatewaygrp','hub','unit','sensor_id','value','utc')->get();
...
$items=DB::table('dbo_payloadercharttemp as db')->where('db.unit', $this->data['unit'])->whereDate('db.utc', Carbon::today())->where('loginid',$this->data['loginid'])->select('agentname','gatewaygrp','hub','unit','sensor_id','value','utc')->get();
...
$items=DB::table('dbo_payloadercharttemp as db')->where('db.unit', $this->data['unit'])->whereRaw('db.utc between "'.$start_month.'" and "'.$end_month.'"')->where('loginid',$this->data['loginid'])->select('agentname','gatewaygrp','hub','unit','sensor_id','value','utc')->get();
...
$items=DB::table('dbo_payloadercharttemp as db')->where('db.unit', $this->data['unit'])->whereRaw('db.utc between "'.$start.'" and "'.$end.'"')->where('loginid',$this->data['loginid'])->select('agentname','gatewaygrp','hub','unit','sensor_id','value','utc')->get();
