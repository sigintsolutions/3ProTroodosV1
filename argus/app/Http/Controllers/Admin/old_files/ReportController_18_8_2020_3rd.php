...
->select('users.fname', 'users.lname','userdatamessages.created_at', 'algorithm.push_message', 'algorithm.id as pid','userdatamessages.readflag','userdatamessages.userdatamsgid as udi','userdatamessages.*')->paginate(1000);*/
/*$items = DB::table('algorithm')		
			->join('userdatamessages', 'userdatamessages.algorithmid', '=', 'algorithm.id')->join('users', 'users.id', '=', 'userdatamessages.userid')->orderBy('userdatamsgid','desc')->select('users.fname', 'users.lname','userdatamessages.created_at', 'algorithm.push_message', 'algorithm.id as pid','userdatamessages.readflag','userdatamessages.userdatamsgid as udi','userdatamessages.*')->take(1000)->get();*/

//$items = DB::table('userdatamessages')->		
			//take(1000)->get();
$items=array();
$countmsgdt=array();
			//$countmsgdt=DB::table('userdatamessages')->where('readflag',0)->get();
...
/*$groups=DB::table('dbo_payloader as db')->where('db.unit', $unit)->whereIn('db.hub', $hubsname)->whereRaw('db.time between "'.$start_week.'" and "'.$end_week.'"')->whereIn('db.sensor_id', $sensor)->select(array('db.*'))->orderby('id','asc')->get();*/
...
/*$groups=DB::table('dbo_payloader as db')->where('db.unit', $unit)->whereIn('db.hub', $hubsname)->whereDate('db.time', Carbon::today())->whereIn('db.sensor_id', $sensor)->orderby('id','asc')->get();*/
...
/*$groups=DB::table('dbo_payloader as db')->where('db.unit', $unit)->whereIn('db.hub', $hubsname)->whereRaw('db.time between "'.$start.'" and "'.$end.'"')->whereIn('db.sensor_id', $sensor)->select(array('db.*'))->orderby('id','asc')->get();*/
...
public function getpushmsg(){
		...
		$items = DB::table('algorithm')->join('userdatamessages', 'userdatamessages.algorithmid', '=', 'algorithm.id')->join('users', 'users.id', '=', 'userdatamessages.userid')->orderBy('userdatamsgid','desc')->select('users.fname', 'users.lname','userdatamessages.created_at', 'algorithm.push_message', 'algorithm.id as pid','userdatamessages.readflag','userdatamessages.userdatamsgid as udi','userdatamessages.*')->paginate(1000);
return view('admin.report.pushmsg')->with(['messages'=>$items]);
	}

public function getpushmsgload(){
		
		$items = DB::table('userdatamessages')->take(100)->get();
return view('admin.report.pushmsgload')->with(['messages'=>$items]);
	}
