...
->select('users.fname', 'users.lname','userdatamessages.created_at', 'algorithm.push_message', 'algorithm.id as pid','userdatamessages.readflag','userdatamessages.userdatamsgid as udi','userdatamessages.*')->paginate(500);
...
//dd("con1");
	...
	/*$updata=DB::table('dbo_payloaderalgorithmtemp')->where('id',$dbovalue)->update($dtup);*/
