...
<div class="row">
	<div class="col-md-12">
		...
		<ul class="nav nav-tabs nav-justified">
			<li class="nav-item">
				<a class="nav-link active" data-toggle="tab" href="#agprofile">Profile</a>
			</li>
			<li class="nav-item">
			...
			<div class="tab-pane active p-3" id="agprofile">
				<form action="{{ url('admin/updateagent') }}" method="POST" enctype="multipart/form-data">
					...
					<div class="row">
						...
						<div class="form-group col-md-4">
							<label class="euz_b" for="">Service Start Date</label>
							<input type="text" class="form-control disname" id="" value="<?php echo $user[0]->service_start; ?>" disabled="disabled" name="service_start" />
						</div>
						<div class="form-group col-md-4">
							<label class="euz_b" for="">Service Expiry</label>
							<input type="text" class="form-control disname" id="" value="<?php echo $user[0]->service_expiry; ?>" disabled="disabled" name="service_expiry" />
						</div>
						<div class="form-group col-md-4">
						...
						<div class="form-group col-md-8 py-2 mb-0">
							...
							<span> (if checked any update in the profile system send email to the corresponding address)</span>
						</div>
						<div class="form-group col-md-12 addsendmailshow" id="addsendmailshow">
							<textarea type="text" class="form-control disname" rows="10" disabled="disabled" name="template">
								<?php if(!empty($user[0]->email_template)) 
									{ 
					...
					<div class="row">
						...
						<div class="form-group col-lg-3 col-md-4">
							...
							<select class="form-control" id="" name="hub">
								...
								?>
								<option value="<?php echo $hub['1']; ?>"><?php echo $hub['1']; ?></option>
								@endforeach
							</select>
						</div>                           
						<div class="form-group col-lg-3 col-md-4">
			...
			<form action="{{ url('admin/updatesensor') }}" method="POST" enctype="multipart/form-data">
				...
				<div class="modal-body">
					<div class="row">
						...
						<div class="form-group col-lg-3 col-md-4">
							<label class="euz_b" for="">Sensor ID</label>
							<select class="form-control" id="sensor_id" name="sensor_id"></select>
						</div>					
						<div class="form-group col-lg-6 col-md-4">
							<label class="euz_b" for="">Name - Modal - Brand</label>
							<div class="input-group">
	...
	$(document).on("click", ".sensoredit", function () 
	{
		...
		$.ajax({
			...
			success:function(data)
			{
				...
				var docurlsensor = urlsensor + "/" + data.hubname + "/" + data.sensor_id;
				$.ajax(
				{
					url : docurlsensor,
					method : "GET",
