...
$loginid=session()->get('userid');
$groups=DB::table('dbo_payloadercharttemp')->where('dbo_payloadercharttemp.unit', $unit)->whereIn('dbo_payloadercharttemp.hub', $hubsname)->whereDate('dbo_payloadercharttemp.utc', Carbon::today())->where('loginid',$loginid)->whereIn('dbo_payloadercharttemp.sensor_id', $sensor)->orderby('id','desc')->get();
