...
$groups=DB::table('dbo_payloadercharttemp as db')->where('loginid',$loginid)->select('db.value','db.utc','db.sensor_id','db.hub','db.hub_sensorid','db.agentname','db.gatewaygrp')->get();
