...
/*$groups=DB::table('dbo_payloadercharttemp')->where('dbo_payloadercharttemp.unit', $unit)->whereIn('dbo_payloadercharttemp.hub', $hubsname)->whereRaw('dbo_payloadercharttemp.utc between "'.$start_week.'" and "'.$end_week.'"')->where('loginid',$loginid)->whereIn('dbo_payloadercharttemp.sensor_id', $sensor)->select(array('dbo_payloadercharttemp.*'))->orderby('id','asc')->get();*/

$groups=DB::table('dbo_payloader as db')->where('db.unit', $unit)->whereIn('db.hub', $hubsname)->whereRaw('db.time between "'.$start_week.'" and "'.$end_week.'"')->where('loginid',$loginid)->whereIn('db.sensor_id', $sensor)->select(array('db.*'))->orderby('id','asc')->get();
...
$loginid=session()->get('userid');
//$groups=DB::table('dbo_payloadercharttemp')->where('dbo_payloadercharttemp.unit', $unit)->whereIn('dbo_payloadercharttemp.hub', $hubsname)->whereDate('dbo_payloadercharttemp.utc', Carbon::today())->where('loginid',$loginid)->whereIn('dbo_payloadercharttemp.sensor_id', $sensor)->orderby('id','asc')->get();
$groups=DB::table('dbo_payloader as db')->where('db.unit', $unit)->whereIn('db.hub', $hubsname)->whereDate('db.time', Carbon::today())->where('loginid',$loginid)->whereIn('db.sensor_id', $sensor)->select(array('db.*'))->orderby('id','asc')->get();
...
//$deldt=DB::table('dbo_payloadercharttemp')->delete();
				$loginid=session()->get('userid');
/*$groups=DB::table('dbo_payloadercharttemp')->where('dbo_payloadercharttemp.unit', $unit)->whereIn('dbo_payloadercharttemp.hub', $hubsname)->whereRaw('dbo_payloadercharttemp.utc between "'.$start_month.'" and "'.$end_month.'"')->where('loginid',$loginid)->whereIn('dbo_payloadercharttemp.sensor_id', $sensor)->select(array('dbo_payloadercharttemp.*'))->orderby('id','asc')->get();*/
//dd("test");
$groups=DB::table('dbo_payloader as db')->where('db.unit', $unit)->whereIn('db.hub', $hubsname)->whereRaw('db.time between "'.$start_month.'" and "'.$end_month.'"')->whereIn('db.sensor_id', $sensor)->select(array('db.*'))->orderby('id','asc')->get();
...
$loginid=session()->get('userid');
/*$groups=DB::table('dbo_payloadercharttemp')->where('dbo_payloadercharttemp.unit', $unit)->whereIn('dbo_payloadercharttemp.hub', $hubsname)->whereRaw('dbo_payloadercharttemp.utc between "'.$start.'" and "'.$end.'"')->where('loginid',$loginid)->whereIn('dbo_payloadercharttemp.sensor_id', $sensor)->select(array('dbo_payloadercharttemp.*'))->orderby('id','asc')->get();*/

$groups=DB::table('dbo_payloader as db')->where('db.unit', $unit)->whereIn('db.hub', $hubsname)->whereRaw('db.time between "'.$start.'" and "'.$end.'"')->where('loginid',$loginid)->whereIn('db.sensor_id', $sensor)->select(array('db.*'))->orderby('id','asc')->get();
...
$deldt=DB::table('dbo_payloadercharttemp')->where('loginid',$loginid)->delete();
$items=DB::table('dbo_payloader')->where('dbo_payloader.unit', $unit)->whereIn('dbo_payloader.hub', $hubsname)->whereRaw('dbo_payloader.utc between "'.$start_week.'" and "'.$end_week.'"')->whereIn('dbo_payloader.sensor_id', $sensor)->get();
...
$deldt=DB::table('dbo_payloadercharttemp')->where('loginid',$loginid)->delete();
$items=DB::table('dbo_payloader')->where('dbo_payloader.unit', $unit)->whereIn('dbo_payloader.hub', $hubsname)->whereDate('dbo_payloader.utc', Carbon::today())->whereIn('dbo_payloader.sensor_id', $sensor)->get();
//->where('agent','like',"%$agent%")
foreach ($items as $item) {
$sensdt=DB::table('sensors')->where('sensor_id',$item->sensor_id)->where('unit',$item->unit)->first();
$hubid=$sensdt->hub_id;
...
$deldt=DB::table('dbo_payloadercharttemp')->where('loginid',$loginid)->delete();
$items=DB::table('dbo_payloader')->whereIn('dbo_payloader.hub', $hubsname)->whereRaw('dbo_payloader.utc between "'.$start_month.'" and "'.$end_month.'"')->whereIn('dbo_payloader.sensor_id', $sensor)->where('dbo_payloader.unit', $unit)->get();
//->where('agent','like',"%$agent%")
foreach ($items as $item) {
	$sensdt=DB::table('sensors')->where('sensor_id',$item->sensor_id)->where('unit',$item->unit)->first();
$hubid=$sensdt->hub_id;
...
$items=DB::table('dbo_payloader')->where('dbo_payloader.unit', $unit)->whereIn('dbo_payloader.hub', $hubsname)->whereRaw('dbo_payloader.utc between "'.$start.'" and "'.$end.'"')->whereIn('dbo_payloader.sensor_id', $sensor)->get();
//->where('agent','like',"%$agent%")
...
$skip=$currentoffset;
$items=DB::table('dbo_payloader')->where('dbo_payloader.unit', $unit)->whereIn('dbo_payloader.hub', $hubsname)->whereRaw('dbo_payloader.utc between "'.$start_week.'" and "'.$end_week.'"')->whereIn('dbo_payloader.sensor_id', $sensor)->orderby('dbo_payloader.id','desc')->skip($skip)->take(100)->get();
//->where('agent','like',"%$agent%")
//->where('agent','like',"%$agent%")
$pageno=$pageno+1;
...
$items=DB::table('dbo_payloader')->where('dbo_payloader.unit', $unit)->whereIn('dbo_payloader.hub', $hubsname)->whereDate('dbo_payloader.utc', Carbon::today())->whereIn('dbo_payloader.sensor_id', $sensor)->orderby('dbo_payloader.id','desc')->skip($skip)->take(100)->get();
//->where('agent','like',"%$agent%")
$pageno=$pageno+1;
...
$currentoffset=$pageno*100;
$skip=$currentoffset;
$items=DB::table('dbo_payloader')->where('dbo_payloader.unit', $unit)->whereIn('dbo_payloader.hub', $hubsname)->whereRaw('dbo_payloader.utc between "'.$start_month.'" and "'.$end_month.'"')->whereIn('dbo_payloader.sensor_id', $sensor)->orderby('dbo_payloader.id','desc')->skip($skip)->take(100)->get();
//->where('agent','like',"%$agent%")
$pageno=$pageno+1;
return view('admin.report.pagination_data2')->with(['items'=>$items,'unit' =>$unit,'hubsname'=> $hubsname,'sensor'=>$sensor,'start_month'=>$start_month,'end_month'=>$end_month,'agent'=>$agent,'group'=>$group,'currentoffset'=>$currentoffset,'pageno'=>$pageno]);
}
...
$currentoffset=$pageno*100;
$skip=$currentoffset;
$items=DB::table('dbo_payloader')->where('dbo_payloader.unit', $unit)->whereIn('dbo_payloader.hub', $hubsname)->whereRaw('dbo_payloader.utc between "'.$start.'" and "'.$end.'"')->whereIn('dbo_payloader.sensor_id', $sensor)->orderby('dbo_payloader.id','desc')->skip($skip)->take(100)->get();
//->where('agent','like',"%$agent%")->
...
$skip=$currentoffset;
$items=DB::table('dbo_payloader')->where('dbo_payloader.unit', $unit)->whereIn('dbo_payloader.hub', $hubsname)->whereRaw('dbo_payloader.utc between "'.$start_week.'" and "'.$end_week.'"')->where('agent','like',"%$agent%")->whereIn('dbo_payloader.sensor_id', $sensor)->orderby('dbo_payloader.id','desc')->skip($skip)->take(100)->get();
//->where('agent','like',"%$agent%")->
$start_month=$start_week;
$end_month=$end_week;
...
$items=DB::table('dbo_payloader')->where('dbo_payloader.unit', $unit)->whereIn('dbo_payloader.hub', $hubsname)->whereDate('dbo_payloader.utc', Carbon::today())->whereIn('dbo_payloader.sensor_id', $sensor)->where('agent','like',"%$agent%")->orderby('dbo_payloader.id','desc')->skip($skip)->take(100)->get();
//->where('agent','like',"%$agent%")->
return view('admin.report.pagination_data2')->with(['items'=>$items,'unit' =>$unit,'hubsname'=> $hubsname,'sensor'=>$sensor,'start_month'=>$start_month,'end_month'=>$end_month,'agent'=>$agent,'group'=>$group,'currentoffset'=>$currentoffset,'pageno'=>$pageno]);
...
$items=DB::table('dbo_payloader')->where('dbo_payloader.unit', $unit)->whereIn('dbo_payloader.hub', $hubsname)->whereRaw('dbo_payloader.utc between "'.$start_week.'" and "'.$end_week.'"')->whereIn('dbo_payloader.sensor_id', $sensor)->orderby('dbo_payloader.id','desc')->skip(0)->take(100)->get();
//->where('agent','like',"%$agent%")
$start_month=$start_week;
$end_month=$end_week;
$skip1=0;
...
$items=DB::table('dbo_payloader')->whereDate('dbo_payloader.utc', Carbon::today())->where('dbo_payloader.unit',"$unit")->whereIn('dbo_payloader.hub',$hubsname)->whereIn('dbo_payloader.sensor_id',$sensor)->orderby('dbo_payloader.id','desc')->skip(0)->take(100)->get();
$itemscount=count($items);
//dd($itemscount);
...
$items=DB::table('dbo_payloader')->where('dbo_payloader.unit', $unit)->whereIn('dbo_payloader.hub', $hubsname)->whereRaw('dbo_payloader.utc between "'.$start_month.'" and "'.$end_month.'"')->whereIn('dbo_payloader.sensor_id', $sensor)->orderby('dbo_payloader.id','desc')->skip(0)->take(100)->get();
//->where('agent','like',"%$agent%")->
...
$items=DB::table('dbo_payloader')->where('dbo_payloader.unit', $unit)->whereIn('dbo_payloader.hub', $hubsname)->whereRaw('dbo_payloader.utc between "'.$start.'" and "'.$end.'"')->whereIn('dbo_payloader.sensor_id', $sensor)->orderby('dbo_payloader.id','desc')->skip(0)->take(100)->get();
//->where('agent','like',"%$agent%")
$start_month=$request->input('from');
$end_month=$request->input('to');
$skip1=0;
