...
$items=DB::table('dbo_payloader')->where('dbo_payloader.unit', $unit)->whereIn('dbo_payloader.hub', $hubsname)->whereDate('dbo_payloader.utc', Carbon::today())->whereIn('dbo_payloader.sensor_id', $sensor)->orderby('dbo_payloader.id','desc')->skip(0)->take(100)->get();
//dd($items);
//->where('agent','like',"%$agent%")->
$start_month=$request->input('from');
$end_month=$request->input('to');
